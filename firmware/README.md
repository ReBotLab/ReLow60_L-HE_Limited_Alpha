...
ReLow60 固有の設定は [`keyboards/ReLow60/`](keyboards/ReLow60/) にあります。以下に続くのはオリジナルの libhmk ドキュメント（英語）です。
...
The ReLow60-specific configuration lives in
[`keyboards/ReLow60/`](keyboards/ReLow60/). The original libhmk documentation
follows below.
